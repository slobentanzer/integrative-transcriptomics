 ...
 */
public class Neo4jUpdateMirDataFromTSV_AllenTaxonomy {
    final static Charset ENCODING = StandardCharsets.UTF_8;

    private static Level logLevel = Level.ALL;
    private static Logger l = Logger.getLogger(Neo4jUpdateMirDataFromTSV_AllenTaxonomy.class.getName());
...
//                            System.out.println(update.toString());
                                        ...
                                        if (result2.keys().size() > 0) // did we find any nodes?
