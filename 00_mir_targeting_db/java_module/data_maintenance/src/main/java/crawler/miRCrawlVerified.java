...
public class miRCrawlVerified {

    public static Robot robot = null;

    private static final Logger crawlLogger = Logger.getLogger(miRCrawlVerified.class.getName());

    public static void getCompRtfFromMiR(String MIMAT, Species species) {
        ...
        File relPath = new File("data/" + species.toString().toLowerCase() + "/ver/" + MIMAT);
        relPath.mkdir();
        String path = null;
        try {
        ...
        File partFile = new File("data/" + species.toString().toLowerCase() + "/ver/" + MIMAT + "/miRNA-gene.part");
        File compFile = new File("data/" + species.toString().toLowerCase() + "/ver/" + MIMAT + "/miRNA-gene");
...
//            System.out.println("Time deducted for already downloaded sets: " + setCount * 15 / 60 + " mins.");
            ...
            driver.get("http://zmf.umm.uni-heidelberg.de/apps/zmf/mirwalk2/miRpub.html");
            ...
            if (species == Species.HSA) {
                new Select(driver.findElement(By.name("specie"))).selectByValue("1");
            } else if (species == Species.MMU) {
                new Select(driver.findElement(By.name("specie"))).selectByValue("5");
            }
...
//            ///////////////////////// STEP 2 /////////////////////////////////////
            ...
            try {
                driver.findElement(By.cssSelector(".bgBox > table:nth-child(7) > tbody:nth-child(3) > tr:nth-child(1) > td:nth-child(1) > center:nth-child(1) > a:nth-child(1)")).click();
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            robot.mouseMove(480, 337); //coordinates of download link are system specific!
            robot.delay(1000);
            ...
            if (!compFile.exists()) {
                ...
                if (partFile.exists()) {
                    ...
                    File f = new File("data/" + species.toString().toLowerCase() + "/ver/" + MIMAT + "/miRNA-gene");
